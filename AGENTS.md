...
For non-trivial implementation work spawned from this thread, use a separate Codex thread with its own worktree. Each implementation thread should read this file, `docs/app-spec.md`, `docs/development-workflow.md`, and `docs/prototype-plan.md` before editing.
