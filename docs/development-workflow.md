...
Use a separate Codex thread with its own worktree for non-trivial implementation work. Keep each spawned thread scoped to one feature, fix, or investigation.
