...
- Animate compact tool group title updates by sliding the old title up and the new title in from below; animate group expand/collapse row insertions and appended tool steps within the platform-backed transcript adapter.
